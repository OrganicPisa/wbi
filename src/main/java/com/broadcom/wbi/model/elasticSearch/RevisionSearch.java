...
public class RevisionSearch implements Serializable {
    ...
    @Field(type = FieldType.Boolean, index = FieldIndex.not_analyzed, searchAnalyzer = "standard", store = true)
    ...
    @Field(type = FieldType.Integer, index = FieldIndex.analyzed, searchAnalyzer = "standard", store = true)

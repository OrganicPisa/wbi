    ...
    .directive(
        ...
        function () {
            return {
                ...
                + "</td>"
                + "<td style='text-align:center'  ng-show='sweditform.$visible'><span editable-checkbox='sw.includeReport' ng-class='{tgreen:sw.includeReport, tred:!sw.includeReport}' "
    ...
    .directive(
        ...
        function () {
            return {
                ...
                + "<td style='border:3px solid #F5f6f7 !important;' ng-repeat='(header, v) in informationTable.title track by $index' ng-if='v || infoeditform.$visible' ng-class={'lightgrey':!arr[header].editable}>"
    ...
    .directive(
        ...
        function () {
            return {
                ...
                + "<tbody>"
                + "<tr ng-repeat='milestone in milestones| orderBy:predicate track by $index' ng-click='milestoneRowClick($index, $event,milestone); resetActiveRowClass();' ng-class='{active:$index == milestoneSelected.index}'>"
                ...
                + "<p ng-show='displayMilestoneStrikeout' ng-if='!$first' ng-repeat='ps in milestone.plan_start.MILESTONE track by $index' title = '{{ps.comment}}' class='tgrey thistory noexport' ng-bind=ps.value></p>"
                + "</td>"
                ...
                + "<p ng-show='displayMilestoneStrikeout' ng-if='!$first' ng-repeat='as in milestone.actual_start.MILESTONE track by $index' title = '{{as.comment}}' class='tgrey thistory noexport' ng-bind=as.value></p>"
                + "</td>"
                ...
                + "<p ng-show='displayMilestoneStrikeout' ng-if='!$first' ng-repeat='ce in milestone.current_end.MILESTONE track by $index' title = '{{ce.comment}}' class='tgrey thistory noexport' ng-bind=ce.value></p>"
                + "</td>"
                ...
                + "<p ng-show='displayMilestoneStrikeout' ng-if='!$first' ng-repeat='ae in milestone.actual_end.MILESTONE track by $index' title = '{{ae.comment}}' class='tgrey thistory noexport' ng-bind=ae.value></p>"
                + "</td>"
    ...
    .directive(
        ...
        function () {
            return {
                ...
                + "<div class='row'>"
                + "<div class='btn-form right-buffer'>"
                ...
                + "<div class='col-sm-7'>"
                + "<label for='milestoneName' class='control-label'>Milestone Name</label>"
                + "<input ng-model='milestoneSelected.name' name='milestoneName' class='form-control' ng-disabled='ms.currentCategory.toLowerCase()==projectCatName' ng-required ng-minlength='2' ng-maxlength='256'>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.name.$error.required'>Milestone name is required.</p>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.name.$error.minlength'>Milestone name is too short.</p>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.name.$error.maxlength'>Milestone name is too long(256 char max).</p>"
                + "</div>"
                + "<div class='col-sm-4'>"
                + "<label for='milestoneOrder' class='control-label'>Order Number</label>"
                + "<input class='form-control' type='number' ng-model='milestoneSelected.order' name='milestoneOrder' ng-disabled='ms.currentCategory.toLowerCase()==projectCatName' ng-required integer min='1' max='10000'>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.order.$error.integer'>Not a valid number!</p>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.order.$error.required'>Milestone Order is required!</p>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.order.$error.min||milestoneeditform.milestoneSelected.order.$error.max'>Out of Range(1-10000)</p>"
                + "</div>"
                + "</div>"
                + "</div>"
                + "<br><div class='row'>"
                ...
                + "<div>"
                + "<label for='milestoneSelected.currentEnd.date' class='control-label'>Plan</label>"
                + "</div>"
                + "<div>"
                + "<i>Last Reported Date:  {{milestoneSelected.currentEnd.snapshot}}</i><br>"
                + "</div>"
                + "<div>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.currentEnd.optionModel' value='NA'> NA</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.currentEnd.optionModel' value='TBD'> TBD</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.currentEnd.optionModel' value='DATE'> DATE</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.currentEnd.optionModel' value='blank'> CLEAR</label>"
                + "<p class='input-group' ng-show=milestoneSelected.currentEnd.optionModel=='DATE'>"
                + "<input type='text' class='form-control' ng-model='milestoneSelected.currentEnd.date' name='milestoneSelected.currentEnd.date' ng-animate='fade'	"
                + "datepicker-options='datePickerOptions' placeholder='Plan End Date' uib-datepicker-popup='MM/dd/yy' "
                + "is-open='milestoneSelected.currentEnd.dateOpenStatus' close-text='Close' ng-readonly='true' ng-value='milestoneSelected.currentEnd.date'"
                + " ng-change='checkPlanEndColor(milestoneSelected.currentEnd.date)'"
                + ">"
                + "<span class='input-group-btn'>"
                + "<button type='button' class='btn btn-default' ng-click='openPlanEndDatePicker($event)'><i class='glyphicon glyphicon-calendar'></i></button>"
                + "</span>"
                + "</p>"
                + "<br>"
                + "<div class='checkbox' data-ng-hide='!allowOrange'> "
                + "<label><input type='checkbox' value='orange' ng-model='ms.orangeStatus'>"
                + "<span class='text-warning'>Orange Override</span></label></div>"
                + "</div>"
                + "<div>"
                + "<label for='milestoneSelected.currentEnd.comment' class='control-label'>Comment</label>"
                + "<textarea class='form-control' ng-model='milestoneSelected.currentEnd.comment' rows='2' ng-maxlength='256' name='milestoneSelected.currentEnd.comment'></textarea>"
                + "<span class='alert-danger' ng-show='milestoneeditform.milestoneSelected.currentEnd.comment.$error.maxlength'>Comment is too long (256 char max)</span>"
                + "</div>"
                + "</div>"
                + "<div class='col-xs-6 col-sm-3'>"
                + "<div>"
                + "<label for='milestoneSelected.actualEnd.date' class='control-label'>Actual</label>"
                + "</div>"
                + "<div>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.actualEnd.optionModel' value='NA'> NA</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.actualEnd.optionModel' value='TBD'> TBD</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.actualEnd.optionModel' value='DATE'> DATE</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.actualEnd.optionModel' value='blank'> CLEAR</label>"
                + "<p class='input-group' ng-show=milestoneSelected.actualEnd.optionModel=='DATE'>"
                + "<input type='text' class='form-control' ng-model='milestoneSelected.actualEnd.date' name='milestoneSelected.actualEnd.date' ng-animate='fade'	"
                + "datepicker-options='actualDatePickerOptions' max-date='actualMaxDate' placeholder='Actual End Date' uib-datepicker-popup='MM/dd/yy' "
                + "is-open='milestoneSelected.actualEnd.dateOpenStatus' close-text='Close' ng-readonly='true' ng-value='milestoneSelected.actualEnd.date'>"
                + "<span class='input-group-btn'>"
                + "<button type='button' class='btn btn-default' ng-click='openActualEndDatePicker($event)'><i class='glyphicon glyphicon-calendar'></i></button>"
                + "</span>"
                + "</p>"
                + "</div>"
                + "<div>"
                + "<label for='milestoneSelected.actualEnd.comment' class='control-label'>Comment</label>"
                + "<textarea class='form-control' ng-model='milestoneSelected.actualEnd.comment' rows='2' ng-maxlength='256' name='milestoneSelected.actualEnd.comment'></textarea>"
                + "<span class='alert-danger' ng-show='milestoneeditform.milestoneSelected.actualEnd.comment.$error.maxlength'>Comment is too long (256 char max)</span>"
                + "</div>"
                + "</div>"
                + "</div>"
                + "</div>"
                ...
                + "<label for='milestoneNote' class='control-label'>Note</label> "
                + "<textarea class='form-control' ng-model='milestoneSelected.note' rows='3' ng-maxlength='511' name='milestoneNote'></textarea>"
                + "<span class='alert-danger' ng-show='milestoneeditform.milestoneSelected.note.$error.maxlength'>Note is too long (512 char max)</span>"
                + "</div>" + "</div>" + "</form>"
            }
        });
App
    .directive(
        ...
        function () {
            return {
                ...
                + "</div>"
                + "<div>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.planStart.optionModel' value='NA'> NA</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.planStart.optionModel' value='TBD'> TBD</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.planStart.optionModel' value='DATE'> DATE</label>"
                + "<p class='input-group' ng-show=milestoneSelected.planStart.optionModel=='DATE'>"
                + "<input type='text' class='form-control' ng-model='milestoneSelected.planStart.date' name='milestoneSelected.planStart.date' ng-animate='fade'	"
                + "datepicker-options='datePickerOptions' placeholder='Plan Start Date' uib-datepicker-popup='MM/dd/yy' "
                + "is-open='milestoneSelected.planStart.dateOpenStatus' close-text='Close' ng-readonly='true' ng-value='milestoneSelected.planStart.date'>"
                + "<span class='input-group-btn'>"
                + "<button type='button' class='btn btn-default' ng-click='openPlanStartDatePicker($event)'><i class='glyphicon glyphicon-calendar'></i></button>"
                + "</span>"
                + "</p>"
                + "</div>"
                + "<div>"
                + "<label for='milestoneSelected.planStart.comment' class='control-label'>Comment</label>"
                + "<textarea class='form-control' ng-model='milestoneSelected.planStart.comment' rows='2' ng-maxlength='256' name='milestoneSelected.planStart.comment'></textarea>"
                + "<span class='alert-danger' ng-show='milestoneeditform.milestoneSelected.planStart.comment.$error.maxlength'>Comment is too long (256 char max)</span>"
                + "</div>"
                + "</div>"
                + "<div class='col-xs-6 col-sm-3'>"
                + "<div>"
                + "<label for='milestoneSelected.actualStart.date' class='control-label'>Actual Start</label>"
                + "</div>"
                + "<div>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.actualStart.optionModel' value='NA'> NA</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.actualStart.optionModel' value='TBD'> TBD</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.actualStart.optionModel' value='DATE'> DATE</label>"
                + "<p class='input-group' ng-show=milestoneSelected.actualStart.optionModel=='DATE'>"
                + "<input type='text' class='form-control' ng-model='milestoneSelected.actualStart.date' name='milestoneSelected.actualStart.date' ng-animate='fade'	"
                + "datepicker-options='datePickerOptions' placeholder='Actual Start Date' uib-datepicker-popup='MM/dd/yy' "
                + "is-open='milestoneSelected.actualStart.dateOpenStatus' close-text='Close' ng-readonly='true' ng-value='milestoneSelected.actualStart.date'>"
                + "<span class='input-group-btn'>"
                + "<button type='button' class='btn btn-default' ng-click='openActualStartDatePicker($event)'><i class='glyphicon glyphicon-calendar'></i></button>"
                + "</span>"
                + "</p>"
                + "</div>"
                + "<div>"
                + "<label for='milestoneSelected.actualStart.comment' class='control-label'>Comment</label>"
                + "<textarea class='form-control' ng-model='milestoneSelected.actualStart.comment' rows='2' ng-maxlength='256' name='milestoneSelected.actualStart.comment'></textarea>"
                + "<span class='alert-danger' ng-show='milestoneeditform.milestoneSelected.actualStart.comment.$error.maxlength'>Comment is too long (256 char max)</span>"
                + "</div>"
                + "</div>"
                + "<div class='col-xs-6 col-sm-3'>"
                + "<div>"
                + "<label for='milestoneSelected.currentEnd.date' class='control-label'>Plan End </label>"
                + "</div>"
                + "<div>"
                + "<i>Last Reported Date:  {{milestoneSelected.currentEnd.snapshot}}</i><br>"
                + "</div>"
                ...
                + "<div class='col-xs-6 col-sm-3'>"
                + "<div>"
                + "<label for='milestoneSelected.actualEnd.date' class='control-label'>Actual End</label>"
                + "</div>"
                + "<div>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.actualEnd.optionModel' value='NA'> NA</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.actualEnd.optionModel' value='TBD'> TBD</label>"
    ...
    .directive(
        ...
        function () {
            return {
                ...
                + "<div class='col-sm-7'>"
                + "<label for='milestoneName' class='control-label'>Milestone Name</label>"
                + "<input ng-model='milestoneSelected.name' name='milestoneName' class='form-control' ng-required ng-minlength='2' ng-maxlength='256'>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.name.$error.required'>Milestone name is required.</p>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.name.$error.minlength'>Milestone name is too short.</p>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.name.$error.maxlength'>Milestone name is too long(256 char max).</p>"
                + "</div>"
                + "<div class='col-sm-4'>"
                + "<label for='milestoneOrder' class='control-label'>Order Number</label>"
                + "<input class='form-control' type='number' ng-model='milestoneSelected.order' name='milestoneOrder' ng-required integer min='1' max='10000'>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.order.$error.integer'>Not a valid number!</p>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.order.$error.required'>Milestone Order is required!</p>"
                + "<p class='alert-danger' ng-show='milestoneeditform.milestoneSelected.order.$error.min||milestoneeditform.milestoneSelected.order.$error.max'>Out of Range(1-10000)</p>"
                + "</div>"
                ...
                + "<div class='col-xs-6 col-sm-3'>"
                + "<div>"
                + "<label for='milestoneSelected.actualStart.date' class='control-label'>Plan</label>"
                + "</div>"
                + "<div>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.actualStart.optionModel' value='NA'> NA</label>"
                + "<label class='radio-inline'><input type='radio' ng-model='milestoneSelected.actualStart.optionModel' value='TBD'> TBD</label>"
                ...
                + "<div class='col-xs-6 col-sm-3'>"
                + "<div>"
                + "<label for='milestoneSelected.currentEnd.date' class='control-label'>Current</label>"
                + "</div>"
                + "<div>"
                + "<i>Last Reported Date:  {{milestoneSelected.currentEnd.snapshot}}</i><br>"
                + "</div>"
